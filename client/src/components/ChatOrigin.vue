  ...
  <div class="chat-container">
    ...
    <div v-if="connect" class="chat-window">
      <div class="messages-container" ref="messagesContainer" @scroll="handleScroll">
        ...
        <button v-if="isShowScrollToBottomBtn" class="messages__tobottom-btn" ref="messagesTobottomBtn"><i class="bi bi-arrow-down-circle"></i></button>
      </div>
...
<script>
  ...
  export default {
    ...
    setup() {
      ...
      //
      const isShowScrollToBottomBtn = ref(false);
      //
      ...
      const handleConnect = () => {
        if(username.value.length > 0) {
          connect.value = true
          socket.onopen  = () => {
            alert("Установлено соединение с сервером!");
          }
        }
      }
